        ...
        <div class="row justify-content-center">
            <div class="mb-3 col-sm-9">
                <ul class="nav nav-tabs" id="myTab" role="tablist">
                    ...
                    <li class="nav-item" role="presentation" id="idpresentation">
                        <button class="nav-link active" id="kelas-terjadwal-tab" data-bs-toggle="tab"
                    ...
                    {{-- <li class="nav-item" role="presentation" id="idpresentation">
                        <button class="nav-link" id="rating-ulasan-tab" data-bs-toggle="tab" data-bs-target="#rating-ulasan"
                            type="button" role="tab" aria-controls="rating-ulasan" aria-selected="false">Rating &
                            Ulasan</button>
                    </li> --}}
                </ul>
            </div>
            <div class="tab-content col-sm-9 col-12">
                <div class="col-12 tab-pane fade" id="deskripsi" role="tabpanel" aria-labelledby="deskripsi-tab">
