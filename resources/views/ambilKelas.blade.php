...
@section('content')
    ...
    <div class="search-container mt-5">
        <form action="{{ route('bidrequests.search') }}" method="GET">
            <input type="text" name="query" id="search-input" placeholder="Cari" value="{{ request('query') }}">
