    ...
    <div class="search m-auto d-flex align-self-center mt-5">
        <div class="search-container" style="margin-top: 4rem;">
            <form action="" method="GET">
                <input type="text" name="p" id="search-input" placeholder="Cari">
                {{-- <button type="submit"> --}}
                <button type="submit" class="search-icon" style="border: none; background-color: white">&#128269;</button>
                {{-- </button> --}}
            </form>
        </div>
    </div>
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    response.forEach(function(item) {
                        var jadwal = new Date(item.jadwal);
                        var hari = jadwal.toLocaleDateString('id-ID', {
                            weekday: 'long'
                        });
                        var tanggal = jadwal.toLocaleDateString('id-ID', {
                            day: 'numeric',
                            month: 'long',
                            year: 'numeric'
                        });
                        var jam_mulai = jadwal.toLocaleTimeString('id-ID', {
                            hour: '2-digit',
                            minute: '2-digit'
                        });
                        var jam_selesai = jadwal.toLocaleTimeString('id-ID', {
                            hour: '2-digit',
                            minute: '2-digit'
                        });
                                ...
                                <div class="container d-flex align-items-center">
                                    <div class="row d-flex my-2" style="width:-webkit-fill-available;">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="75" height="50" fill="currentColor" class="bi bi-cash-coin col-md-3 justify-content-start" viewBox="0 0 16 16">
                                            ...
                                            <path d="M1 0a1 1 0 0 0-1 1v8a1 1 0 0 0 1 1h1v1H.5a.5.5 0 0 0 0 1h4a.5.5 0 0 0 0-1H3v-1h3v1H5.5a.5.5 0 0 0 0 1h4a.5.5 0 0 0 0-1H8v-1h1a1 1 0 0 0 1-1V1a1 1 0 0 0-1-1H1zm1 9V1h7v8H2z" />
                                            <path d="M13 5.5a.5.5 0 0 1-.5-.5v-.61a.5.5 0 0 1 1 0v.61a.5.5 0 0 1-.5.5zm0 2a.5.5 0 0 1-.5-.5V6.39a.5.5 0 0 1 1 0v.61a.5.5 0 0 1-.5.5zm0 2a.5.5 0 0 1-.5-.5V8.39a.5.5 0 0 1 1 0v.61a.5.5 0 0 1-.5.5z" />
                                        </svg>
                                        <p class="mb-2 col-md-9 align-items-center d-flex align-items-center text-start">Rp${item.harga}</p>
                                    </div>
                                </div>
