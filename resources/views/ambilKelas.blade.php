...
<body>
    ...
    <div class="container">
        <div class="">
            <div class="row">
                <h1 class=" d-flex justify-content-center align-items-center my-5">Permintaan Mengajar</h1>
            </div>

            <div class="row d-flex justify-content-center my-4">
                <!-- Mapel 1 -->
                <div class="card col-3 mx-5" style="width: 20rem;">
                    <div class="card-body ">
                      ...
                      <div class="container d-flex align-items-center">
                        <div class="row d-flex my-2">
                            <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" fill="currentColor" class="bi bi-calendar3 col-md-3 justify-content-start" viewBox="0 0 16 16">
                              ...
                              <p class="mb-2 col-md-9 align-items-center d-flex align-items-center text-start">Senin, 30 Mei 2024</p>
                          </div>
                      </div>
                      ...
                      <div class="container d-flex align-items-center">
                        <div class="row d-flex my-2">
                            <svg xmlns="http://www.w3.org/2000/svg" width="75" height="50" fill="currentColor" class="bi bi-alarm col-md-3 justify-content-start" viewBox="0 0 16 16">
                              ...
                              <p class="mb-2 col-md-9 align-items-center d-flex align-items-center text-start">18.00 - 19.00</p>
                          </div>
                      </div>
                      ...
                      <div class="container d-flex align-items-center">
                        <div class="row d-flex my-2">
                            <svg xmlns="http://www.w3.org/2000/svg" width="75" height="50" fill="currentColor" class="bi bi-cash-coin col-md-3 justify-content-start" viewBox="0 0 16 16">
                              ...
                              <p class="mb-2 col-md-9 align-items-center d-flex align-items-center text-start">Rp. 150.000</p>
                          </div>
                      </div>
