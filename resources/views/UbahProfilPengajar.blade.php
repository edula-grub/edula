        ...
        <div class="">
            <div class="katasandi">
                ...
                <div class="fill-namadepan1" style="width: 60%;">
                    <div class="fill-namadepan-item"></div>
                    <input class="nama-depan1" placeholder="Kata sandi lama" type="password" name="katasandilama" />
                </div>
                <br>
                <div class="nama-lengkap1">Kata Sandi Baru</div>
                <div class="fill-namabelakang1" style="width: 60%;">
                    <div class="fill-namabelakang-item"></div>
                    <input class="nama-belakang1" placeholder="Kata sandi baru" type="password" name="katasandibaru"/>
                </div>
